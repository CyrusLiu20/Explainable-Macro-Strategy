...
if __name__ == "__main__":
    ...
    # selected_types = ["economy_fiscal"]
    # date_range = ("20240529T0130", "20250220T0130")
    # selected_types = ["economy_macro"]
    # date_range = ("20220101T0130", "20250220T0130")


    # splittime.process_config(input_file, output_file, selected_types=selected_types, date_range=date_range)
