...
def write_mapping(folder_path=None, output_filename="inidicator_mapping.csv"):

    header_row = ["Series ID", "Renamed Series", "Publishing Delay (Days)", "Trade Frequency"]
    series_data = [
        ("SP500",           "S&P 500",                   0,      "Daily"),
        ("GDP",             "US GDP",                    60,     "Quarterly"),
        ("CPIAUCSL",        "US Urban CPI",              14,     "Monthly"),
        ("UNRATE",          "US Unemployment Rate",      7,      "Monthly"),
        ("MICH",            "Michigan Consumer Sentiment", 21,   "Monthly"),
        ...
        ("UMCSENT",         "University of Michigan Consumer Sentiment", 21, "Monthly"),
        ...
        ("HNFSEPUSSA",      "New One Family Home Sales", 28,     "Monthly"),
